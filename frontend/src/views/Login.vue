  ...
  <div class="login-container">
    <div class="login-card">
      <div class="login-header">
        <h1>POS收银管理系统</h1>
        <p>Retail Point of Sale System</p>
      </div>
...
.login-header h1 { font-size: 24px; color: #303133; margin-bottom: 8px; }
.login-header p { color: #909399; font-size: 13px; }
.login-tips { text-align: center; color: #909399; font-size: 12px; margin-top: 10px; }
</style>
